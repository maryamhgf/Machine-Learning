...
#ataSetPositive["is_weakend"] = np.where(dataSetPositive["Date"].dt.dayofweek.isin([5, 6]), 1, 0)
...
baggibgClassifier = BaggingClassifier(base_estimator=desisionTreeClassifier, n_estimators=10, max_samples=0.5,
